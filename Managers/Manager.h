...
public:
    ...
    vector<vector<Airport*>> scheduleTripMinConnection(Airport* u, Airport* v, vector<Airport*> visit);
    ...
    vector<Airport*> findMinConnectionsExcludeCountries(Airport* s, Airport* t, vector<string> &countries);
